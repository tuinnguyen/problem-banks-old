...
//  * | The function takes 2 values a and b then return pow(a, b)
...
//  * | The function takes 1 value: a string s
//  * | then convert it into an integer 64bit.
...
//  * | The function takes 1 value: an integer s
...
//  * | then return a vector with size of len, all the values inside the vector are between min_value and max_value (32-bit integer).
